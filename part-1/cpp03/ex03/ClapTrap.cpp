...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/07/20 09:59:04 by nettalha          #+#    #+#             */
/*   Updated: 2023/07/20 15:44:58 by nettalha         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
    std::cout << name << " Parametrazied Constructor called" << std::endl;
    this->name = name;
    this->Hit = 10;
    this->Energy = 10;
    this->Attack = 10;
...
ClapTrap::~ClapTrap()
{
    std::cout << name << " Distructor called" << std::endl;
}
